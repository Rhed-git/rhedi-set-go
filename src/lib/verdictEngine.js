...
//
// Pure functions: given weather data + user preferences, returns a Go/Caution/No-Go
// verdict for today and each of the next 6 days, plus the per-day tip strings the
// UI surfaces. No React, no DOM, no fetch — only Date/Math arithmetic and a
// localStorage read for stored preferences.
...
// })
// → { todayVerdict, todayReason, weekVerdicts, weekReasons, weekDryStreakHrs, weekTips, tips }
